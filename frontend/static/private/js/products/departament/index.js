// static/private/js/products/departament/index.js
...
class App {
  constructor() {
    ...
    this.eventHandlers = new EventHandlers(this.state, this.ui, window.ProductsAPI);
  ...
  setupEventListeners() {
    ...
    this.editModal.onUpdate(handlers.onUpdate);
    this.deleteModal.onConfirm(handlers.onConfirmDelete);
  }
