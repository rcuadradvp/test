// static/private/js/clients/index.js

import { initClientsPermissions, assertCanView } from './permissions.js';
...
class App {
  constructor() {
    ...
    this.eventHandlers = new EventHandlers(this.state, this.ui, window.ClientsAPI);
  ...
  async initPermissions() {
    try {
      const permissions = await initClientsPermissions();
