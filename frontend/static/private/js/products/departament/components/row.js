// static/private/js/products/departament/components/row.js
...
export const Row = {
  ...
  getTemplate(item, permissions, showActions) {
    return `
      <td class="department-link-cell" data-href="/productos/${this.escape(item.slug)}/">
      ...
      <td class="text-center department-link-cell" data-href="/productos/${this.escape(item.slug)}/">
  ...
  attachEventHandlers(tr, item, permissions, handlers) {
    const linkCells = tr.querySelectorAll('.department-link-cell');
