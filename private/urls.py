...
urlpatterns = [
    ...
    # ========== NUEVO: Detalle de producto por UUID ==========
    # IMPORTANTE: Esta ruta debe ir ANTES de las rutas con slugs para evitar conflictos
    path('productos/detalle/<uuid:product_id>/', views.product_detail_view, name='product-detail'),
    
    # Productos sin categoría dentro de un departamento (DEBE ir antes de categories-detail)
