// static/private/js/products/products/index.js
...
class App {
  constructor() {
    ...
    if (!this.categorySlug) {
      console.error('[APP] No se encontró category_slug');
    }
    ...
    // Pasar ambos slugs a EventHandlers
