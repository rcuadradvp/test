// static/private/js/products/categories/state-manager.js
...
export class StateManager {
  constructor() {
    this.state = {
      data: [],
      filteredData: [],
      departmentInfo: null, // Información del departamento actual
      permissions: {
        canView: false,
        canCreate: false,
        canEdit: false,
  ...
  setData(data, departmentInfo = null) {
    this.setState({
      data,
      filteredData: this.filterData(data, this.state.searchTerm),
      departmentInfo: departmentInfo || this.state.departmentInfo
    });
  }
  ...
  getDepartmentInfo() {
    return this.state.departmentInfo;
  }
