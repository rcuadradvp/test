...
export class UIRenderer {
  ...
  render(data, permissions, eventHandlers, departmentInfo = null) {
    ...
    // Actualizar la info del departamento si viene
    if (departmentInfo) {
      this.departmentInfo = departmentInfo;
    }
    ...
    // Agregar fila/tarjeta especial para productos sin categoría
    // Usamos el departmentSlug para crear una URL limpia
  ...
  createUnassociatedRow() {
    ...
    // URL limpia usando el slug del departamento
